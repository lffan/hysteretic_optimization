...
plot \
'../Data_1/ACD_256.dat' u (bin($1, 0.001)):(0.1) s f t '$N = 256$', \
'../Data_1/ACD_512.dat' u (bin($1, 0.001)):(0.25) s f t '$N = 512$', \
'../Data_1/ACD_1024.dat' u (bin($1, 0.001)):(0.5) s f t '$N = 1024$', \
'../Data_1/ACD_2048.dat' u (bin($1, 0.001)):(1.0) s f t '$N = 2048$', \
